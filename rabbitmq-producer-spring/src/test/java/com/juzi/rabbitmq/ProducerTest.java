...
public class ProducerTest {
    ...
    public void testTtl() {
        ...
        for (int i = 0; i < 10; i++) {
            // 发送消息
            rabbitTemplate.convertAndSend("test_exchange_ttl", "ttl.hei", "message ttl....");
        }
        ...
        //消息单独过期
        //rabbitTemplate.convertAndSend("test_exchange_ttl", "ttl.hei", "message ttl....",messagePostProcessor);
